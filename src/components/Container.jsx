...
function Container(props) {
    const { location, searchResults, onChange, onSearch, onPlayVideo, onReady, tapeImages } = props;
    console.log(props);
    return (
            <section className="route-section">
                <Switch location={location}>
                    ...
                    render={(props) => <CreateMixtapes {...props} searchResults={searchResults} onReady={onReady} onSearch={onSearch} onChange={onChange} onPlayVideo={onPlayVideo} tapeImages={tapeImages}/>} />
